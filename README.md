...
<div align="center">
  ...
  <!-- Div para colocar o slogan abaixo da logo -->
  <div align="center">
  ...
  <!-- Adicionando um espaço entre o slogan e o conteúdo -->
  <br><br>

  <!-- Breve descrição do intuito do projeto -->
  <h2>Plataforma focada em realizar conexões entre salões de beleza e doadores de cabelo.</h2>

  <!-- Adicionando um espaço entre o que é projeto e o conteúdo -->
  <br><br>
  ...
  <!-- Adicionando um espaço entre o sobre nós e Nossos fios -->
  <br><br>

  <!-- Seção de Nossos fios -->
  ...
  <!-- Adicionando um espaço entre o Nossos fios e Nossa pontas -->
  <br><br>
  ...
  <!-- Adicionando um espaço entre o Nossas Pontas e Nossas Raízes -->
  <br><br>

  <!-- Seção de Nossas Raízes-->
  ...
  <!-- Adicionando um espaço entre o Nossas Raízes e a Equipe -->
  <br><br>
